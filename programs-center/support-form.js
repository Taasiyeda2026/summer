...
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYXNlIiwicmVmIjoic3ppbmxoanV3eWl5c3pkcHNk b3AiLCJyb2xlIjoiYW5vbiIsImlhdCI6MTc3Nzk3MjI5OCwiZXhwIjoyMDkzNTQ4Mjk4fQ.yOK5rkApbYd4jbLAA_FR3F9JvBXJU_6wWCiReu0k70Q'.replace(' ', '');
...
if (supportPartnershipForm) {
  supportPartnershipForm.addEventListener('submit', async (event) => {
    ...
    const ccField = supportPartnershipForm.querySelector('input[name="_cc"]');
    if (ccField) ccField.remove();
